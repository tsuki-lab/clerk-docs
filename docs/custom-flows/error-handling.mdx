...
<CodeBlockTabs options={["JavaScript", "iOS (Swift)"]}>
```js
...
```
```swift
// In order to access the custom properties of the
// clerk error payload (code, meta, etc.),
// you will need to cast your error to the
// ClerkAPIError type.
