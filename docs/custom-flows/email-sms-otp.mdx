...
<Callout type="info">
  Looking for email links? Check out our [Email links authentication](/docs/custom-flows/email-links) guide.
</Callout>
...
<Tabs type="framework" items={["Next.js", "React", "JavaScript", "iOS (Swift)"]}>
  <Tab>
...
You can also verify your users via their email address. There are two additional helper methods:
...
Both work the same way as their phone number counterparts do. You can find all available methods in the [`SignUp`](/docs/references/javascript/sign-in/sign-in) object documentation.
